            ...
            <div className="footer">
                <div className="row">
                    <div className="col-lg-5 col-sm-6 col-xs-6">
                        ...
                        <div><span className="image"><img src={require('../assets/Shape-3.png')} /></span>9917 E.BELL RD. STE.120 /<br/> SCOTTSDALE, AZ / 85260</div>
                    </div>
                    <div className="col-lg-4 col-sm-0 col-xs-1"></div>
                    <div className="col-lg-3  col-sm-6 col-xs-5 text-right">
